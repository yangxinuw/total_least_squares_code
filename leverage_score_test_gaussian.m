...
%             B(n+1,1)=3;
        ...
        s1=sprintf('gaussian-ratio-%s+%s.txt',methods(iname),methods(jname));
        s2=sprintf('gaussian-time-%s+%s.txt',methods(iname),methods(jname));
        s3=sprintf('gaussian-S-%s+%s.txt',methods(iname),methods(jname));
